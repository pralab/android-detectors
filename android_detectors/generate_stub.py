#!/usr/bin/env python3
"""
This was generated by Copilot. I have no idea of what it contains.
It just works.
"""
...
from config import DETECTOR_INTERFACE
...
def main(argv=None) -> int:
    ...
    method_blocks: List[List[str]] = []
    for name in DETECTOR_INTERFACE:
    ...
    out_path = in_path.parent / f"{in_path.stem}_dockerized.py"
    try:
