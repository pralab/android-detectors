...
if __name__ == "__main__":
    ...
    clf_path = os.path.join(
        base_path, "../src/models/drebin/drebin_vectorizer.pkl")
    vect_path = os.path.join(
        base_path, "../src/models/drebin/drebin_classifier.pkl")
    ...
    with open(os.path.join(base_path,  "submission_drebin_track_3.json"),
              "w") as f:
        json.dump(results, f)
